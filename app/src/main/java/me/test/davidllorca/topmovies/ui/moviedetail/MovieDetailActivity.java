 ...
 * in a {@link MovieListActivity}. // TODO
 */
public class MovieDetailActivity extends AppCompatActivity implements MovieDetailContract.View {
    ...
    public static Intent getIntentByMovie(Context context, Movie movie) {
        ...
        extras.putParcelable(MovieDetailActivity.MOVIE, movie);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showMovie(mItem = getIntent().getExtras().getParcelable(MovieDetailActivity.MOVIE));
    ...
    public void showMovie(Movie movie) {
        if (mAppBarLayout != null) {
            ...
            mOverViewTextView.setText(mItem.getOverview());
        }
    }
}
